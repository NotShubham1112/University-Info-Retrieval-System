            ...
            <div className="min-w-0 flex-1">
              ...
              {(student.latest_sgpa != null || student.backlog_count != null || student.latest_result_status) && (
                <p className="mt-3 text-xs text-muted-foreground">
                  ...
                  {student.latest_declared_at ? <span className="ml-1" suppressHydrationWarning>({new Date(student.latest_declared_at).toLocaleDateString("en-GB", { timeZone: "UTC" })})</span> : null}
                </p>
              )}
